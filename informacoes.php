...
<body>
    <div class="header">
        ...
        <div class="nav">
            <ul>
                <li onmouseover="mudaFoto('Imagens/home.png')" onmouseout="mudaFoto('Imagens/informacoes.png')"><a href="home.php">Home</a></li>
                <li onmouseover="mudaFoto('Imagens/informacoes.png')" onmouseout="mudaFoto('Imagens/informacoes.png')"><a href="informacoes.php">Informações</a></li>
                <li onmouseover="mudaFoto('Imagens/agendamentos.png')" onmouseout="mudaFoto('Imagens/informacoes.png')"><a href="agendamentos.php?PAGINA=login">Agendamento</a></li>
                <li onmouseover="mudaFoto('Imagens/contatos.png')" onmouseout="mudaFoto('Imagens/informacoes.png')"><a href="contatos.php">Fale Conosco</a></li>
            </ul>
        </div><!--nav -->
