...
<body>
    <div class="header">
        ...
        <div class="nav">
            <ul>
                <li onmouseover="mudaFoto('Imagens/home.png')" onmouseout="mudaFoto('Imagens/home.png')"><a href="home.php">Home</a></li>
                <li onmouseover="mudaFoto('Imagens/informacoes.png')" onmouseout="mudaFoto('Imagens/home.png')"><a href="informacoes.php">Informações</a></li>
                <li onmouseover="mudaFoto('Imagens/agendamentos.png')" onmouseout="mudaFoto('Imagens/home.png')"><a href="agendamentos.php?PAGINA=login">Agendamento</a></li>
                <li onmouseover="mudaFoto('Imagens/contatos.png')" onmouseout="mudaFoto('Imagens/home.png')"><a href="contatos.php">Fale Conosco</a></li>
            </ul>
        </div><!--nav -->
    ...
    <div class="corpo">
        <div class="articles">
        OLHAR no https://www.behance.net/
        github
...
<p>Suco de cevadiss, é um leite divinis, qui tem lupuliz, matis, aguis e fermentis. Interagi no mé, cursus quis, vehicula ac nisi. Aenean vel dui dui. Nullam leo erat, aliquet quis tempus a, posuere ut mi. Ut scelerisque neque et turpis posuere pulvinar pellentesque nibh ullamcorper. Pharetra in mattis molestie, volutpat elementum justo. Aenean ut ante turpis. Pellentesque laoreet mé vel lectus scelerisque interdum cursus velit auctor. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam ac mauris lectus, non scelerisque augue.</p> Aenean justo massa.
